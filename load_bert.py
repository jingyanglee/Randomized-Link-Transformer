...
class bert_model(object):
	def __init__(self):
		...
		output_model_file = os.path.join("/home/jingyang/Desktop/CVAE-Chatbot/transformer/data/nli_model", "pytorch_model.bin")
